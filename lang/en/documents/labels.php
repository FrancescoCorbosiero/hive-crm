...
return [
    ...
    'actions' => [
        ...
        'import_xml_description' => 'Upload one or more FPR12 / FPA12 XML files. Only invoices where YOU are the Cedente (CodiceFiscale matches OWNER_CODICE_FISCALE) are accepted. Re-importing the same file is safe: fatture already present for (year, number) are skipped.',
