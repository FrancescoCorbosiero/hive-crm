...
return [
    ...
    'convert' => [
        ...
        'website_cost' => 'Website setup cost',
        'website_cost_helper' => 'Leave blank to skip logging the cost. Otherwise a LOSS entry is created in Finance, idempotent per website.',
        'website_paid_at' => 'Website paid on',
        'website_method' => 'Website payment method',
