...
/**
 * Stable string aliases for the Transaction polymorphic source column.
 *
 * These values are written to the DB. Adding a new source ⇒ add a new
 * case here; never reuse an existing value for a different meaning.
 *
